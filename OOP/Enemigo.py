class Enemigo:
    ...
    def habla(self):
        print(f"Yo soy {self._tipo_enemigo}. Preparando para pelear!!")

    def camina(self):
         print(f"Yo soy {self._tipo_enemigo}. Se mueve cerca de ti!!!")
    
    def atacar(self):
         print(f"Yo soy {self._tipo_enemigo}. ataca con un {self.ataque} de daño!!")